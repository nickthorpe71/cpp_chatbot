...
# the context window contains the current line the character is
# speaking and n lines preceeding it
# context window of size 7
n = 7

# a context window is useful here because we are creating a conversational model
